namespace :ptourist do
  ...
  task subjects: [:users] do
    puts "creating types"
    museum_type = create_type label: 'museum'
    tour_type = create_type label: 'tour'
    hotel_type = create_type label: 'hotel'
    ...
    create_thing thing, organizer, members, images, [museum_type, tour_type]
    ...
    create_thing thing, organizer, members, images, tour_type
    ...
    create_thing thing, organizer, members, images, hotel_type
    ...
    create_thing thing, organizer, members, images, museum_type
